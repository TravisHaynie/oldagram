             ...
             `  
                <article>
                    ...
                    <section>
                        ...
                        <button class="heart" title="button" onclick="likesIncremented(${i})" id=${i} >
                        ...
                        <p class="likes" id="like-el-${i}">${posts[i].likes} likes</p>
...
function likesIncremented(index) {
    const likeEl = document.getElementById(`like-el-${index}`);
    posts[index].likes++
    likeEl.textContent = posts[index].likes + " " + "likes";
}
